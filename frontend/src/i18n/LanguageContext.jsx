...
const translations = {
  en: {
    ...
    // Crime Map
    crimeIntel: "Crime Intelligence", crimeMap: "Crime Hotspot Map",
    casesPlotted: "cases plotted across Tamil Nadu", back: "Back",
    allBranches: "All Branches", allStages: "All Stages",
    loadingMap: "Loading map data...", viewCase: "View Case",
    psLimit: "PS Limit", crimeNo: "Crime Number", sectionLaw: "Section of Law (IPC)",
    dateOccur: "Date of Occurrence", dateReg: "Date of Registration",
    accusedDetails: "Accused Details", stageLocked: "Stage locked to",
    // Create Case
    fileNewCase: "File a New Case", newCase: "New Case",
    complainantName: "Complainant Name", gistOfCase: "Gist of Case",
    actionToBeTaken: "Action to be Taken", filing: "Filing...",
    fileCase: "File Case", backToCases: "Back to Cases",
    caseIdentifiers: "Case Identifiers", partiesDetails: "Parties & Case Details",
    notLoggedIn: "Not logged in", caseCreateFail: "Failed to create case",
    // Case Logs
    activityLogs: "Activity Logs", logEntries: "Log Entries",
    updatesToday: "Updates Today", stageChanges: "Stage Changes",
    actionUpdates: "Action Updates", blockchainVerified: "Blockchain Verified",
    loadingLogs: "Loading activity logs...", searchLogs: "Search by crime no., officer, value...",
    allChangeTypes: "All Change Types", allOfficers: "All Officers",
    entries: "entries", prevValue: "Previous Value", newValue: "New Value",
    anchoredOn: "Anchored on Sepolia", block: "Block", viewOnEtherscan: "View on Etherscan",
    anchoringPending: "Anchoring pending",
    // Login
    caseOfficer: "Case Officer", supervisor: "Supervisor",
    login: "Login", logout: "Logout", username: "Username", password: "Password",
    enterUser: "Enter your username", enterPass: "Enter your password",
    authDenied: "Authentication entry denied", googleLinked: "Google Account Linked",
    mfaFirstTime: "First time login detected. Please define 2 personal security questions.",
    customQ: "Custom Question", answer: "Answer", linkGoogle: "Link your Google account (Optional)",
    authPersonnel: "Authorized personnel only", authenticating: "Authenticating...",
    cancel: "Cancel", mfaSetupFail: "MFA Setup failed", mfaSuccess: "Security questions saved securely!",
    enterCreds: "Please enter credentials or sign in with Google.",
    fullTitle: "Cases of Anti-Terrorism Squad", recordedBy: "Recorded By", time: "Time",
    dashboard: "Dashboard", cases: "Cases", verified: "Verified", pending: "Pending",
    stageChanged: "Stage Changed", caseLogsHeader: "Case Update Logs", synced: "Synced",
  },
  ta: {
    // Common
    ...
    // Crime Map
    crimeIntel: "குற்ற உளவுத்துறை", crimeMap: "குற்ற ஹாட்ஸ்பாட் வரைபடம்",
    casesPlotted: "தமிழகம் முழுவதும் வழக்குகள் வரைபடமாக்கப்பட்டுள்ளன", back: "பின்செல்",
    allBranches: "அனைத்து கிளைகள்", allStages: "அனைத்து நிலைகள்",
    loadingMap: "வரைபடத் தரவை ஏற்றுகிறது...", viewCase: "வழக்கைப் பார்",
    psLimit: "காவல் நிலைய வரம்பு", crimeNo: "குற்ற எண்", sectionLaw: "சட்டப் பிரிவு (IPC)",
    dateOccur: "சம்பவம் நடந்த தேதி", dateReg: "பதிவு செய்யப்பட்ட தேதி",
    accusedDetails: "ஆரோபி விவரங்கள்", stageLocked: "நிலை பூட்டப்பட்டுள்ளது",
    // Create Case
    fileNewCase: "புதிய வழக்கைத் தாக்கல் செய்", newCase: "புதிய வழக்கு",
    complainantName: "புகார்தாரர் பெயர்", gistOfCase: "வழக்கின் சுருக்கம்",
    actionToBeTaken: "எடுக்கப்பட வேண்டிய நடவடிக்கை", filing: "தாக்கல் செய்யப்படுகிறது...",
    fileCase: "வழக்கைத் தாக்கல் செய்", backToCases: "வழக்குகளுக்குத் திரும்பு",
    caseIdentifiers: "வழக்கு அடையாளங்கள்", partiesDetails: "தரப்பினர் மற்றும் வழக்கு விவரங்கள்",
    notLoggedIn: "உள்நுழையவில்லை", caseCreateFail: "வழக்கை உருவாக்குவதில் தோல்வி",
    // Case Logs
    activityLogs: "செயல்பாட்டுப் பதிவுகள்", logEntries: "பதிவு உள்ளீடுகள்",
    updatesToday: "இன்றைய புதுப்பிப்புகள்", stageChanges: "நிலை மாற்றங்கள்",
    actionUpdates: "நடவடிக்கை புதுப்பிப்புகள்", blockchainVerified: "பிளாக்செயின் சரிபார்க்கப்பட்டது",
    loadingLogs: "செயல்பாட்டுப் பதிவுகளை ஏற்றுகிறது...", searchLogs: "குற்ற எண், அதிகாரி, மதிப்பால் தேடு...",
    allChangeTypes: "அனைத்து மாற்ற வகைகள்", allOfficers: "அனைத்து அதிகாரிகள்",
    entries: "உள்ளீடுகள்", prevValue: "முந்தைய மதிப்பு", newValue: "புதிய மதிப்பு",
    anchoredOn: "செபோலியாவில் நங்கூரமிடப்பட்டது", block: "பிளாக்", viewOnEtherscan: "ஈதர்ஸ்கானில் பார்",
    anchoringPending: "நங்கூரமிடுதல் நிலுவையில் உள்ளது",
    // Login
    caseOfficer: "வழக்கு அதிகாரி", supervisor: "கண்காணிப்பாளர்",
    login: "உள்நுழை", logout: "வெளியேறு", username: "பயனர் பெயர்", password: "கடவுச்சொல்",
    enterUser: "உங்கள் பயனர் பெயரை உள்ளிடவும்", enterPass: "உங்கள் கடவுச்சொல்லை உள்ளிடவும்",
    authDenied: "அங்கீகாரம் மறுக்கப்பட்டது", googleLinked: "கூகிள் கணக்கு இணைக்கப்பட்டது",
    mfaFirstTime: "முதல் முறை உள்நுழைவு கண்டறியப்பட்டது. தயவுசெய்து 2 பாதுகாப்பு கேள்விகளை வரையறுக்கவும்.",
    customQ: "தனிப்பயன் கேள்வி", answer: "பதில்", linkGoogle: "உங்கள் கூகிள் கணக்கை இணைக்கவும் (விருப்பமானது)",
    authPersonnel: "அங்கீகரிக்கப்பட்ட பணியாளர்கள் மட்டுமே", authenticating: "அங்கீகரிக்கப்படுகிறது...",
    cancel: "ரத்து செய்", mfaSetupFail: "MFA அமைப்பு தோல்வியடைந்தது", mfaSuccess: "பாதுகாப்பு கேள்விகள் வெற்றிகரமாக சேமிக்கப்பட்டன!",
    enterCreds: "தயவுசெய்து நற்சான்றிதழ்களை உள்ளிடவும் அல்லது கூகிள் மூலம் உள்நுழையவும்.",
    fullTitle: "பயங்கரவாத எதிர்ப்புப் படை வழக்குகள்", recordedBy: "பதிவு செய்தவர்", time: "நேரம்",
    dashboard: "டாஷ்போர்டு", cases: "வழக்குகள்", verified: "சரிபார்க்கப்பட்டது", pending: "நிலுவையில் உள்ளது",
    stageChanged: "நிலை மாற்றப்பட்டது", caseLogsHeader: "வழக்கு புதுப்பிப்பு பதிவுகள்", synced: "ஒத்திசைக்கப்பட்டது",
  },
  hi: {
    // Common
    ...
    // Crime Map
    crimeIntel: "अपराध खुफिया", crimeMap: "अपराध हॉटस्पॉट मानचित्र",
    casesPlotted: "तमिलनाडु में मामले प्लॉट किए गए हैं", back: "पीछे",
    allBranches: "सभी शाखाएं", allStages: "सभी चरण",
    loadingMap: "मानचित्र डेटा लोड हो रहा है...", viewCase: "मामला देखें",
    psLimit: "पुलिस स्टेशन सीमा", crimeNo: "अपराध संख्या", sectionLaw: "कानून की धारा (IPC)",
    dateOccur: "घटना की तिथि", dateReg: "पंजीकरण की तिथि",
    accusedDetails: "आरोपी विवरण", stageLocked: "चरण लॉक है",
    // Create Case
    fileNewCase: "नया मामला दर्ज करें", newCase: "नया मामला",
    complainantName: "शिकायतकर्ता का नाम", gistOfCase: "मामले का सारांश",
    actionToBeTaken: "की जाने वाली कार्रवाई", filing: "फाइल किया जा रहा है...",
    fileCase: "मामला फाइल करें", backToCases: "मामलों पर वापस जाएं",
    caseIdentifiers: "मामले के पहचानकर्ता", partiesDetails: "पक्ष और मामले का विवरण",
    notLoggedIn: "लॉग इन नहीं है", caseCreateFail: "मामला बनाने में विफल",
    // Case Logs
    activityLogs: "गतिविधि लॉग", logEntries: "लॉग प्रविष्टियां",
    updatesToday: "आज के अपडेट", stageChanges: "चरण परिवर्तन",
    actionUpdates: "कार्रवाई अपडेट", blockchainVerified: "ब्लॉकचेन सत्यापित",
    loadingLogs: "गतिविधि लॉग लोड हो रहा है...", searchLogs: "अपराध संख्या, अधिकारी, मूल्य द्वारा खोजें...",
    allChangeTypes: "सभी परिवर्तन प्रकार", allOfficers: "सभी अधिकारी",
    entries: "प्रविष्टियां", prevValue: "पिछला मान", newValue: "नया मान",
    anchoredOn: "सेपोलिया पर एंकर किया गया", block: "ब्लॉक", viewOnEtherscan: "Etherscan पर देखें",
    anchoringPending: "एंकरिंग लंबित है",
    // Login
    caseOfficer: "मामला अधिकारी", supervisor: "पर्यवेक्षक",
    login: "लॉग इन करें", logout: "लॉग आउट करें", username: "उपयोगकर्ता नाम", password: "पासवर्ड",
    enterUser: "अपना उपयोगकर्ता नाम दर्ज करें", enterPass: "अपना पासवर्ड दर्ज करें",
    authDenied: "प्रमाणीकरण अस्वीकार कर दिया गया", googleLinked: "गूगल खाता लिंक किया गया",
    mfaFirstTime: "पहली बार लॉगिन पाया गया। कृपया 2 सुरक्षा प्रश्न परिभाषित करें।",
    customQ: "कस्टम प्रश्न", answer: "उत्तर", linkGoogle: "अपना गूगल खाता लिंक करें (वैकल्पिक)",
    authPersonnel: "केवल अधिकृत कर्मी", authenticating: "प्रमाणित किया जा रहा है...",
    cancel: "रद्द करें", mfaSetupFail: "MFA सेटअप विफल रहा", mfaSuccess: "सुरक्षा प्रश्न सफलतापूर्वक सुरक्षित किए गए!",
    enterCreds: "कृपया क्रेडेंशियल दर्ज करें या गूगल के साथ साइन ইন करें।",
    fullTitle: "आतंकवाद विरोधी दस्ता मामले", recordedBy: "द्वारा रिकॉर्ड किया गया", time: "समय",
    dashboard: "डैशबोर्ड", cases: "मामले", verified: "सत्यापित", pending: "लंबित",
    stageChanged: "चरण बदला गया", caseLogsHeader: "मामला अपडेट लॉग", synced: "सिंक किया गया",
  },
};
